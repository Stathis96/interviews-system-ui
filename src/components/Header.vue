    ...
    <header class="text-gray-100 bg-neutral body-font shadow w-full h-20">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <a
                ...
                <img src="https://pazly.dev/logo.png" style="height: 40px;"
                    alt="logo">
                <span class="ml-3 text-xl">Interviews System</span>
            </a>
            <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
            <button class="w-10 h-10 bg-neutral-focus hover:bg-indigo-700 text-white font-bold  rounded " @click="logout">
